...
"""Run real MEGABYTE Window Codec compression over per-source FASTA content.
...
Historical statistical/non-.mbw compression lives in
scripts/run_dna_compression_opengenome2_legacy.py.
...
Example:
    python scripts/run_dna_compression_opengenome2.py \
      ...
      --window-codec-devices cuda:1 cuda:3 \
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--output-dir",
        default=None,
        help="Directory for compression_compare.json, CSVs, plots, and default window_codec. Defaults to <run-dir>/statistics_opengenome2_fasta_100mb.",
    )
    ...
    parser.add_argument(
        ...
        default=None,
        help="Directory for real framed MEGABYTE window bitstreams (.mbw + .json). Defaults to <output-dir>/window_codec.",
    )
    parser.add_argument(
...
def main() -> None:
    ...
    output_dir = Path(args.output_dir) if args.output_dir else run_dir / "statistics_opengenome2_fasta_100mb"
    ...
    window_codec_out_dir = Path(args.window_codec_out_dir) if args.window_codec_out_dir else output_dir / "window_codec"
